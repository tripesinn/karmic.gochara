...
def generate_karmic_chart_svg(natal_positions, transit_positions=None, lang='fr', transit_date=None):
    ...
    svg = [
        ...
        '  <stop offset="0%" stop-color="#1a1050" stop-opacity="0.55"/>',
        f'  <stop offset="100%" stop-color="{_BG}" stop-opacity="0"/>',
        '</radialGradient>',
        # Arrowhead markers for evolution arrows
        '<marker id="arw-cyan" markerWidth="5" markerHeight="5" refX="5" refY="2.5" orient="auto">',
        f'  <path d="M 0 0 L 5 2.5 L 0 5 Z" fill="{_CYAN}"/>',
        '</marker>',
        '<marker id="arw-purple" markerWidth="5" markerHeight="5" refX="5" refY="2.5" orient="auto">',
